                    ...
                    >
                        ...
                        <div className="w-full flex flex-col items-center justify-center mt-2">
                            <span className="block text-base font-semibold text-blue-50 text-center tracking-wide">
                                Mạng xã hội của cảm xúc – <span className="text-yellow-200 font-bold">nhịp điệu của bạn</span>.
                            </span>
                            <span className="block text-base font-semibold text-blue-50 text-center tracking-wide mt-1">
                                Với <span className="text-yellow-200 font-bold">Bing Bong</span>, mọi cảm xúc đều được ngân vang.
                            </span>
                        </div>
