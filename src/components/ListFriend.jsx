        ...
        <div className="fixed top-0 right-0 px-4 overflow-y-auto max-h-[92vh] custom-scroll pt-16">
                    ...
                    {[1, 2].map((ad, idx) => (
                        <div key={idx} className="flex items-center gap-3 bg-white/70 p-2 rounded-lg shadow hover:shadow-md transition-all">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="text-sm text-gray-500">zalo.me</p>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <div className="py-4">
                <div className="flex items-center justify-between mb-4">
                    <h1 className="text-gray-600 text-lg font-semibold">Contacts</h1>
                    <div className="flex items-center gap-3">
                        <div className="hover:bg-gray-300 bg-white/70 rounded-full size-9 flex items-center justify-center shadow cursor-pointer transition">
